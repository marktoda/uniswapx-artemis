...
pub mod mock_fee_controller_duplicates {
    ...
    pub static MOCKFEECONTROLLERDUPLICATES_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl ::core::convert::From<TransferOwnershipCall> for MockFeeControllerDuplicatesCalls {
