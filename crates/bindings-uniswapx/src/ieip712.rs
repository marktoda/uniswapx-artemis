...
pub mod ieip712 {
    ...
    pub static IEIP712_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for IEIP712<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IEIP712))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for IEIP712<M> {
