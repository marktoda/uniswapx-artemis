...
pub mod i_signature_transfer {
    ...
    impl<M> ::core::fmt::Debug for ISignatureTransfer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ISignatureTransfer)).field(&self.address()).finish()
        }
    }
