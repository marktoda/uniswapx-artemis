...
pub mod permit_signature {
    ...
    impl<M: ::ethers::providers::Middleware> PermitSignature<M> {
        ...
        pub fn type_hash(&self) -> ::ethers::contract::builders::ContractCall<M, [u8; 32]> {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, PermitSignatureEvents>
        {
            self.0
    ...
    impl ::ethers::core::abi::AbiDecode for PermitSignatureCalls {
        fn decode(
            ...
            if let Ok(decoded) = <TypeHashCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for PermitSignatureCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::TypeHash(element) => ::ethers::core::abi::AbiEncode::encode(element),
