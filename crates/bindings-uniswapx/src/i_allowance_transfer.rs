...
pub mod i_allowance_transfer {
    ...
    impl<M> ::core::fmt::Debug for IAllowanceTransfer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IAllowanceTransfer)).field(&self.address()).finish()
        }
    }
